                ...
                <div class="card user-card user-card-1 mt-4">
					<div class="card-header border-0 p-2 pb-0">
						<div class="cover-img-block">
							...
							<?php }?>
							<?php if($row0->videos != ''){?>
							<iframe width="380px" height="327px" src="https://www.youtube.com/embed/<?php echo $row0->videos?>">
							</iframe>
							<?php }?>
						</div>
					</div>
                    <div class="card-body pt-0">
                        <div class="text-center">
							<h4 class="mb-1 mt-3"><?php echo $row0->created_by?></h4>
                            <p class="mb-3 text-muted"><i class="feather icon-calendar"> </i> <?php $date=date_create($row0->completed_on);
                            ...
                            <p class="mb-0"><b>Project Title : </b><span class="badge badge-warning"><?php echo $row0->project_title?></span></p>
                            <p class="mb-0"><b>Client : </b><span class="badge badge-warning"><?php echo $row0->client?></span></p>
							<p class="mb-0"><b>Categories : </b>
							<?php
							      $categories_id_ex = explode(',', $row0->categories_id);
							      foreach($categories as $row1){  
							      $key = array_search($row1->categories_id, $categories_id_ex) . 'yes';
							      if($key != 'yes'){
							?>
                            <span class="badge badge-warning"><?php echo $row1->catergory_title?></span>
							<?php }
								  }?>
							</p>
					...
					<div class="col text-right pb-3">
						<div class="dropdown">
							...
							<div class="dropdown-menu dropdown-menu-right">
								<a class="dropdown-item" href="<?php echo site_url('Portfolio/edit_project/'.$row0->portfolio_id)?>">Edit</a>
								<a onClick="return confirm('Are you sure you want to delete this card?')" class="dropdown-item" href="<?php echo site_url('Portfolio/delete_project/'.$row0->portfolio_id)?>">delete</a>
							</div>
						</div>
					</div>
                </div>
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input required type="text" class="form-control" name="project_title" placeholder="Project Title">
							</div>
						</div>
					</div>
					<div class="row">
