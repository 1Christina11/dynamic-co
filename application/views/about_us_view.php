		<!-- Page Title
		============================================= -->
		<section id="page-title" class="page-title-parallax page-title-dark include-header" style="padding: 250px 0; background-image: url('<?php echo base_url()?>assets/images/about/parallax.jpg'); background-size: cover; background-position: center center;" data-bottom-top="background-position:0px 400px;" data-top-bottom="background-position:0px -500px;">

			<div class="container clearfix">
				<h1>About Us</h1>
				<span><?php echo $about_us->title?></span>
				<ol class="breadcrumb">
				...
				<div class="container clearfix">
					...
					<div class="row col-mb-50 mb-0">
						...
						<div class="col-lg-4">
							...
							<p><?php echo $about_us->paragraph?></p>
...
-->
				...
				<div class="container clearfix">
					...
					<ul class="clients-grid grid-2 grid-sm-3 grid-md-6 mb-0">
						...
						<li class="grid-item"><img src="<?php echo base_url()?>actrl/assets/images/our_clients/<?php echo $row->client_logo?>" alt="Clients"></li>
						<?php }?>
					</ul>
