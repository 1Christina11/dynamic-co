						...
						">
							<div class="grid-inner">
								...
								<?php $services_title=str_replace(" ","-",$row0->services_title) ?>
												...
												<div class="slide"><a href="<?php echo site_url('Dynamic/service/'.$services_title.'/'.$row0->services_id) ?>"><img style="width:377px; height:327px !important" src="<?php echo base_url()?>actrl/assets/images/service_file/<?php echo $row1->photo?>" alt="Shake It"></a></div>
												<?php }
													  }?>
											</div>
										</div>
